...
const ProductCard = () => {
  return (
    <div className="w-full max-w-[450px]  border border-gray-200 rounded-lg shadow-sm bg-white text-black">
      <a href="#">
        <img
      ...
      <div className="px-8 pb-5 flex flex-col gap-y-2">
        ...
        <div className="flex flex-col space-x-0.5 font-semibold">
          <div className="flex gap-x-2">
            <span className="text-xl">Launched Price : </span>
            <span className="flex">
              <RupeeIcon fill="#0c0c0c" width="18px" height="30px" />
              <span className="text-xl">2999</span>
            </span>
          </div>
