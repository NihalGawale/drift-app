    ...
    <div className="w-full h-auto  bg-[#F2F1ED] py-[60px] px-[84px] relative">
      <div className="w-full h-full z-10 flex flex-col gap-y-20">
        <div className="w-[50%] flex flex-col gap-y-30">
          <h3 className="text-7xl font-bold tracking-wide">Products</h3>
        ...
        <div className="w-full flex justify-center mt-10">
          <button
            className=" bg-black text-white hover:bg-white hover:text-black shadow-xl font-semibold text-lg px-8 py-4 font-roboto flex items-center justify-center rounded-full gap-x-3 cursor-pointer"
